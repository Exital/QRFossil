...
function AppRoutes() {
  ...
  return (
    <>
      ...
      {showSetup && (
        <div className="fixed bottom-gutter left-[calc(280px+24px)] z-50 max-w-sm rounded-lg border border-primary/30 bg-primary-fixed px-md py-sm text-body-sm text-on-primary-fixed shadow-card">
